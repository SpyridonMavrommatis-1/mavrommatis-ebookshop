 ...
 * Each book:
 * <ul>
 *    <li>Is associated with {@link AuthorEntity} (many-to-one)</li>
...
public class BookEntity {
     ...
     */
    public BookEntity(String title, String language, String genre, String literaryForm, String isbn,
                      boolean isCollective, AuthorEntity author) {
        this.title = title;
